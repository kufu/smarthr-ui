...
export const locale = {
  ...
  'smarthr-ui/RichTextEditor/linkDialogTitle': '设置链接',
  ...
  'smarthr-ui/RichTextEditor/linkUrlInvalid': '请输入有效的URL（http://、https:// 或 mailto:）',
  'smarthr-ui/RichTextEditor/youtube': '嵌入YouTube视频',
  'smarthr-ui/RichTextEditor/youtubeDialogTitle': '嵌入YouTube视频',
