...
export const locale = {
  ...
  'smarthr-ui/DropdownMenuButton/triggerInactive': '站看选项',
  ...
  'smarthr-ui/FilterDropdown/applyButton': '启用',
  'smarthr-ui/FilterDropdown/cancelButton': '取消',
  'smarthr-ui/FilterDropdown/resetButton': '解除筛选条件',
  'smarthr-ui/FilterDropdown/status': '已启用',
  'smarthr-ui/FilterDropdown/triggerButton': '筛选',
  ...
  'smarthr-ui/SingleCombobox/destroyButtonIconAlt': '删除',
  'smarthr-ui/SortDropdown/applyButtonLabel': '启用',
  ...
  'smarthr-ui/SortDropdown/sortOrderLabel': '排列顺序',
