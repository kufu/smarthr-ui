...
export const locale = {
  ...
  'smarthr-ui/ModelessDialog/dialogHandlerAriaRoleDescription': 'Draggable',
  'smarthr-ui/ModelessDialog/dialogHandlerDescription': 'Use the arrow keys to position the dialog up, down, left, and right',
