...
export const locale = {
  ...
  'smarthr-ui/RichTextEditor/linkDialogTitle': 'Đặt liên kết',
  ...
  'smarthr-ui/RichTextEditor/linkUrlInvalid': 'Vui lòng nhập URL hợp lệ (http://, https://, hoặc mailto:)',
  'smarthr-ui/RichTextEditor/youtube': 'Nhúng video YouTube',
  'smarthr-ui/RichTextEditor/youtubeDialogTitle': 'Nhúng video YouTube',
