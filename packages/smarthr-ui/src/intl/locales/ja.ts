...
export const locale = {
  ...
  'smarthr-ui/RichTextEditor/linkDialogTitle': 'リンクを設定',
  ...
  'smarthr-ui/RichTextEditor/linkUrlInvalid': '有効なURL（http://, https://, mailto:）を入力してください',
  'smarthr-ui/RichTextEditor/youtube': 'YouTube動画を埋め込む',
  'smarthr-ui/RichTextEditor/youtubeDialogTitle': 'YouTube動画を埋め込む',
