...
const wrapperClassNameGenerator = tv({
  ...
  compoundSlots: [
    ...
    },
    {
      ...
      variant: 'primary',
      className: [
        'shr-border-main shr-bg-main shr-text-white',
        'focus-visible:shr-border-main-darken focus-visible:shr-bg-main-darken',
        'hover:shr-border-main-darken hover:shr-bg-main-darken',
        'forced-colors:shr-border-double forced-colors:shr-border-4',
      ],
    },
    {
      slots: ['button'],
    ...
    },
    {
      ...
      variant: 'skeleton',
      className: [
        'shr-border-white shr-bg-transparent shr-text-white',
        'focus-visible:shr-border-white-darken focus-visible:shr-bg-overlay focus-visible:shr-text-white-darken',
        'hover:shr-border-white-darken hover:shr-bg-overlay hover:shr-text-white-darken',
        'forced-colors:shr-border-none',
      ],
    },
    {
      slots: ['button'],
    ...
    },
    {
      ...
      variant: 'text',
      className: [
        'shr-border-transparent shr-bg-transparent shr-text-black',
        'focus-visible:shr-bg-white-darken',
        'hover:shr-bg-white-darken',
        'forced-colors:shr-border-none',
      ],
