...
export const UnlabeledCheckbox = forwardRef<HTMLInputElement, Props>(
  ({ id, checked, mixed, error, className, children, disabled, ...props }, ref) => {
    const classNames = useMemo(() => {
      const { wrapper, innerWrapper, box, input, iconWrap, icon } = classNameGenerator()
