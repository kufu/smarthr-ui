...
import { _messages, _onCloseHandlers } from './NotificationBar.stories'
  ...
  render: (args: any) => (
    <Stack {...args} className="shr-bg-base-grey shr-min-h-[50vh] shr-p-1">
      <NotificationBar
        ...
        bold={true}
        type="warning"
        message={_messages.ReactNode}
        layer={4}
        onClose={_onCloseHandlers.あり}
      />
      <NotificationBar
        base="base"
        bold={false}
        type="success"
        message={_messages.String}
        layer={4}
        onClose={_onCloseHandlers.なし}
      />
      <NotificationBar
        base="base"
        bold={false}
