...
exports.RightFixedNote = function (_a) {
    ...
    return (react_1.default.createElement(Wrapper, { themes: theme, width: width, onSubmit: handleSubmit, className: className },
        ...
        items &&
            items.map(function (item) { return (react_1.default.createElement(RightFixedNoteItem_1.RightFixedNoteItem, __assign({ key: item.id }, item, { showEditButton: enableEdit, onClickEdit: onClickEdit }))); }),
