...
const BaseColumn = ({ padding = 1, ...props }) => {
    const themes = (0, useTheme_1.useTheme)();
    return react_1.default.createElement(Base, { ...props, padding: padding, layer: 0, themes: themes });
};
exports.BaseColumn = BaseColumn;
const Base = (0, styled_components_1.default)(Base_1.Base) `
  ${({ bgColor = 'COLUMN', themes: { color } }) => (0, styled_components_1.css) `
    border-radius: unset;
