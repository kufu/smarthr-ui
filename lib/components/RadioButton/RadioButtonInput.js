...
exports.RadioButtonInput = (0, react_1.forwardRef)(({ onChange, ...props }, ref) => {
    ...
    return (react_1.default.createElement(Wrapper, { themes: theme },
        react_1.default.createElement(Input, { ...props, type: "radio", onChange: handleChange, className: classNames.radioButton, themes: theme, ref: ref }),
