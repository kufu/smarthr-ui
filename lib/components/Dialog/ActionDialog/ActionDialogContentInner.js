...
const ActionDialogContentInner = ({ children, title, titleId, subtitle, titleTag = 'h2', actionText, actionTheme = 'primary', onClickAction, onClickClose, responseMessage, actionDisabled = false, closeDisabled, decorators, }) => {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        ...
        react_1.default.createElement(ActionArea, { themes: theme, ref: bottomRef, className: classNames.actionArea },
            react_1.default.createElement(ButtonArea, { className: classNames.buttonArea },
                ...
                react_1.default.createElement(Button_1.Button, { variant: actionTheme, onClick: handleClickAction, disabled: actionDisabled, loading: isRequestProcessing, className: classNames.actionButton }, actionText)),
