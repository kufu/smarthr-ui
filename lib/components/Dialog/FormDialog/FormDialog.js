...
const FormDialog = ({ children, title, subtitle, titleTag, actionText, actionTheme, onSubmit, onClickClose, onPressEscape = onClickClose, responseMessage, actionDisabled = false, closeDisabled, className = '', portalParent, decorators, ...props }) => {
    ...
    return createPortal(react_1.default.createElement(DialogContentInner_1.DialogContentInner, { ...props, ariaLabelledby: titleId, className: className, onPressEscape: onPressEscape },
        react_1.default.createElement(FormDialogContentInner_1.FormDialogContentInner, { title: title, titleId: titleId, subtitle: subtitle, titleTag: titleTag, actionText: actionText, actionTheme: actionTheme, actionDisabled: actionDisabled, closeDisabled: closeDisabled, onClickClose: handleClickClose, onSubmit: handleSubmitAction, responseMessage: responseMessage, decorators: decorators }, children)));
};
