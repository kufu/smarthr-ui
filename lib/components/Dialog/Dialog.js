...
exports.Dialog = function (_a) {
    ...
    return react_dom_1.createPortal(react_1.default.createElement(DialogContentInner_1.DialogContentInner, __assign({ onClickOverlay: onClickOverlay, onPressEscape: onPressEscape, isOpen: isOpen }, props), children), element);
};
