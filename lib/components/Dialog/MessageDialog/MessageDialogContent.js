...
const MessageDialogContent = ({ title, description, portalParent, className = '', decorators, ...props }) => {
    ...
    return createPortal(react_1.default.createElement(DialogContentInner_1.DialogContentInner, { ...props, onClickOverlay: onClickClose, onPressEscape: onClickClose, isOpen: active, className: className },
        react_1.default.createElement(MessageDialogContentInner_1.MessageDialogContentInner, { title: title, titleId: titleId, description: description, onClickClose: handleClickClose, decorators: decorators })));
};
exports.MessageDialogContent = MessageDialogContent;
