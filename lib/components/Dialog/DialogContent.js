...
exports.DialogContent = function (_a) {
    ...
    return (react_1.default.createElement(DialogContentRoot, null,
        react_1.default.createElement(exports.DialogContentContext.Provider, { value: { onClickClose: onClickClose } },
            react_1.default.createElement(DialogContentInner_1.DialogContentInner, __assign({ isOpen: active, onClickOverlay: onClickClose, onPressEscape: onClickClose }, props), children))));
};
