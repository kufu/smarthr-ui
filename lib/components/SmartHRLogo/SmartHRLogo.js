...
const SmartHRLogo = ({ alt = 'SmartHR（スマートHR）', width, height = '1.5em', fill = 'white', className = '', ...props }) => {
...
const Wrapper = styled_components_1.default.figure `
  ${({ $width, $height, themes: { leading, space } }) => (0, styled_components_1.css) `
    ...
    `}
`;
const convertValue = (value) => (typeof value === 'string' ? value : `${value}px`);
