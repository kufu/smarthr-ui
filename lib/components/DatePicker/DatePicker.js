...
exports.DatePicker = function (_a) {
    ...
    var _c = react_1.useState(stringToDate(value)), selectedDate = _c[0], setSelectedDate = _c[1];
    ...
    var _e = react_1.useState(false), isInputFocused = _e[0], setIsInputFocused = _e[1];
    var _f = react_1.useState(false), isCalendarShown = _f[0], setIsCalendarShown = _f[1];
