...
exports.Header = function (_a) {
    ...
    return (react_1.default.createElement(Wrapper, { themes: theme, className: className },
        ...
        react_1.default.createElement(HeaderColumn, null,
            react_1.default.createElement(HeaderButton_1.HeaderButton, { icon: "fa-question-circle", onClick: onClickHelp }, "\u30D8\u30EB\u30D7"),
            isAdmin && (react_1.default.createElement(react_1.default.Fragment, null,
                react_1.default.createElement(HeaderButton_1.HeaderButton, { icon: "fa-th-list", onClick: onClickCrewList }, "\u5F93\u696D\u54E1\u30EA\u30B9\u30C8"),
                react_1.default.createElement(HeaderCrewDropdown_1.HeaderCrewDropdown, { onClickNew: onClickNewCrew, onClickBulkInsert: onClickBulkInsertCrews, onClickBulkUpdate: onClickBulkUpdateCrews, onClickInvite: onClickInviteCrew }))),
            react_1.default.createElement(HeaderNotification_1.HeaderNotification, { length: notificationLength, onClick: onClickNotification }),
            react_1.default.createElement(HeaderUserDropdown_1.HeaderUserDropdown, { isAdmin: isAdmin, isCrew: isCrew, displayName: displayName, currentTenantName: currentTenantName, avatar: avatar, onClickAccount: onClickAccount, onClickLogout: onClickLogout, onClickProfile: onClickProfile, onClickCompany: onClickCompany, onClickSchool: onClickSchool }))));
};
