...
exports.Calendar = react_1.forwardRef(function (_a, ref) {
    ...
    react_1.useEffect(function () {
        if (value && isValidValue) {
            setCurrentMonth(dayjs_1.default(value));
        }
    }, [value, isValidValue]);
    var prevMonth = currentMonth.subtract(1, 'month');
    var nextMonth = currentMonth.add(1, 'month');
    return (react_1.default.createElement(Container, { themes: themes, ref: ref },
