...
exports.YearPicker = function (_a) {
    ...
    var focusingRef = react_1.useRef(null);
    ...
    return (react_1.default.createElement(Container, null, yearArray.map(function (year) {
        ...
        return (react_1.default.createElement(YearButton, { key: year, themes: themes, onClick: function () { return onSelectYear(year); }, "aria-pressed": isSelectedYear, ref: isThisYear ? focusingRef : null },
