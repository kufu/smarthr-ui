...
exports.FormGroup = function (_a) {
    ...
    return (react_1.default.createElement(Wrapper, { className: className },
        react_1.default.createElement(Label, { themes: theme, id: labelId, margin: innerMargin },
            ...
            helpMessage && (react_1.default.createElement(HelpMessage, { themes: theme, className: disabledClass }, helpMessage)),
            errorMessages &&
                errorMessages.map(function (errorMessageItem, index) { return (react_1.default.createElement(ErrorMessage, { themes: theme, key: index, className: disabledClass },
                    ...
                    react_1.default.createElement(ErrorText, null, errorMessageItem))); })),
...
var TitleWrapper = styled_components_1.default.div(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n  display: flex;\n  align-items: baseline;\n  flex-wrap: wrap;\n"], ["\n  display: flex;\n  align-items: baseline;\n  flex-wrap: wrap;\n"])));
var Title = styled_components_1.default(Heading_1.Heading)(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n  display: inline-block;\n"], ["\n  display: inline-block;\n"])));
var StatusLabels = styled_components_1.default.span(templateObject_7 || (templateObject_7 = __makeTemplateObject(["\n  ", "\n"], ["\n  ",
    "\n"])), function (_a) {
    var themes = _a.themes;
    var size = themes.size;
    return styled_components_1.css(templateObject_6 || (templateObject_6 = __makeTemplateObject(["\n      margin-left: ", ";\n      display: inline-block;\n      line-height: 1;\n    "], ["\n      margin-left: ", ";\n      display: inline-block;\n      line-height: 1;\n    "])), size.pxToRem(size.space.XXS));
});
var LabelItem = styled_components_1.default(StatusLabel_1.StatusLabel)(templateObject_9 || (templateObject_9 = __makeTemplateObject(["\n  ", "\n"], ["\n  ",
    "\n"])), function (_a) {
    var themes = _a.themes;
    var size = themes.size;
    return styled_components_1.css(templateObject_8 || (templateObject_8 = __makeTemplateObject(["\n      margin-right: ", ";\n      display: inline-block;\n    "], ["\n      margin-right: ", ";\n      display: inline-block;\n    "])), size.pxToRem(4));
});
var HelpMessage = styled_components_1.default.div(templateObject_11 || (templateObject_11 = __makeTemplateObject(["\n  ", "\n"], ["\n  ",
    "\n"])), function (_a) {
    var themes = _a.themes;
    var size = themes.size, palette = themes.palette;
    return styled_components_1.css(templateObject_10 || (templateObject_10 = __makeTemplateObject(["\n      margin-top: ", ";\n      font-size: ", ";\n\n      &.disabled {\n        color: ", ";\n      }\n    "], ["\n      margin-top: ", ";\n      font-size: ", ";\n\n      &.disabled {\n        color: ", ";\n      }\n    "])), size.pxToRem(size.space.XXS), size.pxToRem(size.font.TALL), palette.TEXT_DISABLED);
});
...
var ErrorText = styled_components_1.default.span(templateObject_14 || (templateObject_14 = __makeTemplateObject(["\n  vertical-align: middle;\n"], ["\n  vertical-align: middle;\n"])));
var ErrorIcon = styled_components_1.default(Icon_1.Icon)(templateObject_16 || (templateObject_16 = __makeTemplateObject(["\n  ", "\n"], ["\n  ",
    "\n"])), function (_a) {
    var themes = _a.themes;
    var size = themes.size;
    return styled_components_1.css(templateObject_15 || (templateObject_15 = __makeTemplateObject(["\n      margin-right: ", ";\n      vertical-align: middle;\n    "], ["\n      margin-right: ", ";\n      vertical-align: middle;\n    "])), size.pxToRem(4));
});
var Body = styled_components_1.default.div(templateObject_17 || (templateObject_17 = __makeTemplateObject(["\n  display: block;\n"], ["\n  display: block;\n"])));
