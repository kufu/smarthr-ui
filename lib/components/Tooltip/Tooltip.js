...
var tooltipFactory = function (balloonTheme) { return function (_a) {
    ...
    return (react_1.default.createElement(Wrapper, { "aria-describedby": isVisible ? tooltipId : undefined, ref: ref, onMouseEnter: overAction, onTouchStart: overAction, onFocus: overAction, onMouseLeave: outAction, onTouchEnd: outAction, onBlur: outAction, tabIndex: 0, isIcon: isIcon },
        isVisible &&
            rect &&
            react_dom_1.createPortal(react_1.default.createElement(TooltipPortal_1.TooltipPortal, { id: tooltipId, parentRect: rect, isIcon: isIcon, isMultiLine: multiLine, horizontal: horizontal, vertical: vertical },
