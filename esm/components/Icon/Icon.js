import { FaAddressBook, FaAddressCard, FaAngleDoubleDown, FaAngleDoubleLeft, FaAngleDoubleRight, FaAngleDown, FaAngleLeft, FaAngleRight, FaAngleUp, FaArchive, FaArrowAltCircleDown, FaArrowAltCircleLeft, FaArrowAltCircleRight, FaArrowAltCircleUp, FaArrowCircleDown, FaArrowDown, FaArrowLeft, FaArrowRight, FaArrowUp, FaArrowsAlt, FaArrowsAltH, FaArrowsAltV, FaAsterisk, FaBan, FaBars, FaBell, FaBellSlash, FaBirthdayCake, FaBolt, FaBook, FaBookOpen, FaBookmark, FaBox, FaBoxOpen, FaBoxes, FaBriefcase, FaBuilding, FaBullhorn, FaBus, FaBusAlt, FaBusinessTime, FaCalculator, FaCalendar, FaCalendarAlt, FaCalendarCheck, FaCalendarDay, FaCalendarMinus, FaCalendarPlus, FaCalendarTimes, FaCalendarWeek, FaCamera, FaCar, FaCarAlt, FaCarSide, FaCaretDown, FaCaretLeft, FaCaretRight, FaCaretSquareDown, FaCaretSquareLeft, FaCaretSquareRight, FaCaretSquareUp, FaCaretUp, FaChartArea, FaChartBar, FaChartLine, FaChartPie, FaCheck, FaCheckCircle, FaCheckSquare, FaChevronCircleDown, FaChevronCircleLeft, FaChevronCircleRight, FaChevronCircleUp, FaChevronDown, FaChevronLeft, FaChevronRight, FaChevronUp, FaCircle, FaClipboard, FaClipboardCheck, FaClipboardList, FaClock, FaClone, FaCloud, FaCloudDownloadAlt, FaCloudUploadAlt, FaCode, FaCog, FaCogs, FaCoins, FaColumns, FaComment, FaCommentAlt, FaCommentDots, FaCommentSlash, FaComments, FaCompress, FaCompressAlt, FaCopy, FaCreditCard, FaCube, FaCubes, FaDatabase, FaDoorClosed, FaDoorOpen, FaEdit, FaEllipsisH, FaEllipsisV, FaEnvelope, FaEnvelopeOpen, FaEnvelopeOpenText, FaExchangeAlt, FaExclamation, FaExclamationCircle, FaExclamationTriangle, FaExpand, FaExpandAlt, FaExpandArrowsAlt, FaExternalLinkAlt, FaEye, FaEyeSlash, FaFile, FaFileAlt, FaFileArchive, FaFileDownload, FaFileExport, FaFileImport, FaFileUpload, FaFilter, FaFlag, FaFolder, FaFolderMinus, FaFolderOpen, FaFolderPlus, FaFont, FaForward, FaGift, FaGlobe, FaGraduationCap, FaGripHorizontal, FaGripLines, FaGripLinesVertical, FaGripVertical, FaHandPaper, FaHandPointDown, FaHandPointLeft, FaHandPointRight, FaHandPointUp, FaHands, FaHandshake, FaHeart, FaHistory, FaHome, FaHospital, FaHospitalAlt, FaHourglass, FaHourglassEnd, FaHourglassHalf, FaHourglassStart, FaIdBadge, FaIdCard, FaIdCardAlt, FaImage, FaImages, FaInbox, FaInfo, FaInfoCircle, FaKey, FaKeyboard, FaLightbulb, FaLink, FaList, FaListAlt, FaListOl, FaListUl, FaLock, FaLockOpen, FaLongArrowAltDown, FaLongArrowAltLeft, FaLongArrowAltRight, FaLongArrowAltUp, FaMedkit, FaMinus, FaMinusCircle, FaMinusSquare, FaMobile, FaMobileAlt, FaMoneyBill, FaMoneyBillAlt, FaMoneyBillWave, FaMoneyBillWaveAlt, FaMoneyCheck, FaMoneyCheckAlt, FaPaperPlane, FaPaperclip, FaPaste, FaPen, FaPencilAlt, FaPhone, FaPhoneSlash, FaPiggyBank, FaPlane, FaPlay, FaPlayCircle, FaPlus, FaPlusCircle, FaPlusSquare, FaPoll, FaPollH, FaPortrait, FaPowerOff, FaPrint, FaQrcode, FaQuestion, FaQuestionCircle, FaRandom, FaReceipt, FaRedo, FaRedoAlt, FaRegClock, FaRegDotCircle, FaRegLightbulb, FaReply, FaReplyAll, FaRocket, FaSave, FaSearch, FaSearchMinus, FaSearchPlus, FaShare, FaShareAlt, FaShareSquare, FaShieldAlt, FaShoppingBag, FaShoppingBasket, FaShoppingCart, FaSignInAlt, FaSignOutAlt, FaSlidersH, FaSort, FaSortAlphaDown, FaSortAlphaUp, FaSortAmountDown, FaSortAmountUp, FaSortDown, FaSortNumericDown, FaSortNumericUp, FaSortUp, FaStar, FaStepBackward, FaStepForward, FaStickyNote, FaStop, FaStopCircle, FaStream, FaSubway, FaSync, FaSyncAlt, FaTable, FaTablet, FaTabletAlt, FaTachometerAlt, FaTag, FaTags, FaTasks, FaTaxi, FaTh, FaThLarge, FaThList, FaTimes, FaTimesCircle, FaToolbox, FaTools, FaTrash, FaTrashAlt, FaTrashRestore, FaTrashRestoreAlt, FaUndo, FaUndoAlt, FaUnlink, FaUnlock, FaUnlockAlt, FaUser, FaUserAlt, FaUserAltSlash, FaUserCheck, FaUserCircle, FaUserClock, FaUserCog, FaUserEdit, FaUserMinus, FaUserPlus, FaUserSlash, FaUsers, FaUsersCog, FaVideo, FaVideoSlash, FaVolumeDown, FaVolumeMute, FaVolumeOff, FaVolumeUp, FaWallet, FaWindowClose, FaWindowMaximize, FaWindowMinimize, FaWindowRestore, FaWrench, FaYenSign, } from 'react-icons/fa';
