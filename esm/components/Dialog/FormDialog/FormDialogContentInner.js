...
export const FormDialogContentInner = ({ children, title, titleId, subtitle, titleTag = 'h2', actionText, actionTheme = 'primary', onSubmit, onClickClose, responseMessage, actionDisabled = false, closeDisabled, decorators, }) => {
    ...
    return (React.createElement("form", { onSubmit: handleSubmitAction },
        ...
        React.createElement(ActionArea, { themes: theme, ref: bottomRef, className: classNames.actionArea },
            React.createElement(ButtonArea, { className: classNames.buttonArea },
                ...
                React.createElement(Button, { type: "submit", variant: actionTheme, disabled: actionDisabled, loading: isRequestProcessing, className: classNames.actionButton }, actionText)),
