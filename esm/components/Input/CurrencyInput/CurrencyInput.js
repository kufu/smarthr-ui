...
export var CurrencyInput = forwardRef(function (_a, ref) {
    ...
    var formatValue = useCallback(function (formatted) {
    ...
    return React.createElement(Input, __assign({ type: "text", onFocus: handleFocus, onBlur: handleBlur, ref: innerRef }, props));
});
