...
export var FormGroup = function (_a) {
    ...
    return (React.createElement(Wrapper, { className: className },
        React.createElement(Label, { themes: theme, id: labelId, margin: innerMargin },
            ...
            helpMessage && (React.createElement(HelpMessage, { themes: theme, className: disabledClass }, helpMessage)),
            errorMessages &&
                errorMessages.map(function (errorMessageItem, index) { return (React.createElement(ErrorMessage, { themes: theme, key: index, className: disabledClass },
                    ...
                    React.createElement(ErrorText, null, errorMessageItem))); })),
...
var Title = styled(Heading)(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n  display: inline-block;\n"], ["\n  display: inline-block;\n"])));
var StatusLabels = styled.span(templateObject_7 || (templateObject_7 = __makeTemplateObject(["\n  ", "\n"], ["\n  ",
    "\n"])), function (_a) {
    var themes = _a.themes;
    var size = themes.size;
    return css(templateObject_6 || (templateObject_6 = __makeTemplateObject(["\n      margin-left: ", ";\n      display: inline-block;\n      line-height: 1;\n    "], ["\n      margin-left: ", ";\n      display: inline-block;\n      line-height: 1;\n    "])), size.pxToRem(size.space.XXS));
});
var LabelItem = styled(StatusLabel)(templateObject_9 || (templateObject_9 = __makeTemplateObject(["\n  ", "\n"], ["\n  ",
    "\n"])), function (_a) {
    var themes = _a.themes;
    var size = themes.size;
    return css(templateObject_8 || (templateObject_8 = __makeTemplateObject(["\n      margin-right: ", ";\n      display: inline-block;\n    "], ["\n      margin-right: ", ";\n      display: inline-block;\n    "])), size.pxToRem(4));
});
var HelpMessage = styled.div(templateObject_11 || (templateObject_11 = __makeTemplateObject(["\n  ", "\n"], ["\n  ",
    "\n"])), function (_a) {
    var themes = _a.themes;
...
var ErrorText = styled.span(templateObject_14 || (templateObject_14 = __makeTemplateObject(["\n  vertical-align: middle;\n"], ["\n  vertical-align: middle;\n"])));
var ErrorIcon = styled(Icon)(templateObject_16 || (templateObject_16 = __makeTemplateObject(["\n  ", "\n"], ["\n  ",
    "\n"])), function (_a) {
    var themes = _a.themes;
    var size = themes.size;
    return css(templateObject_15 || (templateObject_15 = __makeTemplateObject(["\n      margin-right: ", ";\n      vertical-align: middle;\n    "], ["\n      margin-right: ", ";\n      vertical-align: middle;\n    "])), size.pxToRem(4));
});
var Body = styled.div(templateObject_17 || (templateObject_17 = __makeTemplateObject(["\n  display: block;\n"], ["\n  display: block;\n"])));
