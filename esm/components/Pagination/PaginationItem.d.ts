...
export declare const PaginationItem: VFC<Props>;
export declare const ItemButton: import("styled-components").StyledComponent<React.ForwardRefExoticComponent<import("../Button").BaseProps & {
...
} & React.RefAttributes<HTMLButtonElement>>, any, {
    square: true;
    size: "s";
} & {
    themes: Theme;
