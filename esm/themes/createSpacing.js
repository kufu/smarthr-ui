...
export const createSpacing = (userBaseSize = defaultBaseSize) => getSpacing(userBaseSize);
export const createSpacingByChar = (userBaseSize = defaultBaseSize) => (size) => getSpacingByChar(userBaseSize)[size];
