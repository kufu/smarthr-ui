...
const tooltipFactory: (theme: TooltipTheme) => React.FC<Props & InjectedProps> = theme => ({
  horizontal,
  vertical,
  className = '',
  ...props
...
export const LightTooltip = withTheme(tooltipFactory('light'))
export const DarkTooltip = withTheme(tooltipFactory('dark'))
