...
export const アイコンの生成: Story = () => {
  const GitHubIcon = generateIcon((props) => (
    // svg で書く場合 stroke や fill などを適宜指定しないと、その他のアイコンと同等に扱えません。
    <svg
      {...props}
      stroke="currentColor"
      fill="currentColor"
  ...
  return (
    <Stack>
      <p>
        ...
        <br />
        SmartHR の Icon は react-icons を使っているため、<code>svg</code> 要素の代わりに
        <code> IconBase </code>を使うことをお勧めします。
      </p>
      <BaseColumn>
        <Cluster>
          <GitHubIcon />
