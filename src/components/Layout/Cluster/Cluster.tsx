...
type Props<T extends React.ElementType> = ComponentPropsWithoutRef<T> &
  PropsWithChildren<
...
export function _Cluster<T extends React.ElementType = 'div'>(
  { as, gap = 0.5, ...props }: Props<T>,
...
export const Cluster = fixedForwardRef(_Cluster)
