...
export const useClassNames = () => {
  const generateBackgroundJobsList = useClassNameGenerator(
    BackgroundJobsList.displayName || 'BackgroundJobsList',
  )
  const generateBackgroundJobsPanel = useClassNameGenerator(
