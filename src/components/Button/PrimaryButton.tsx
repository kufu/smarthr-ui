...
export const PrimaryButton: React.FC<ButtonProps> = withTheme(injectStyle(BaseButton))
export const PrimaryButtonAnchor: React.FC<AnchorProps> = withTheme(injectStyle(BaseButtonAnchor))
